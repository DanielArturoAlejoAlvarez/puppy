...
urlpatterns = [
    ...
    url(r'^pet/', include('app.pet.urls', namespace='pet')),

    url(r'^adoption/', include('app.adoption.urls', namespace='adoption')),

    url(r'^all_user/', include('app.all_user.urls', namespace='all_user')),
